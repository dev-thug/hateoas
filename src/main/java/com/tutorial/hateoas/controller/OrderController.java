...
import com.tutorial.hateoas.assembler.OrderModelAssembler;
import com.tutorial.hateoas.entity.Order;
import com.tutorial.hateoas.entity.Status;
import com.tutorial.hateoas.repository.OrderRepository;
    ...
    ResponseEntity<?> cancel(@PathVariable Long id) {
        ...
        return ResponseEntity
                ...
                .body(Problem.create()
                        ...
                        .withDetail("You cat't cancel an order that is in the " + order.getStatus() + "status"));
    }
